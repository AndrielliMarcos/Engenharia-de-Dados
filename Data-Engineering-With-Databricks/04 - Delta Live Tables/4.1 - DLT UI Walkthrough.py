...
# MAGIC     * Embora este documento seja um Notebook Databricks padrão, a sintaxe é esoecializada em declarações de tabela DLT
...
# MAGIC %md
# MAGIC Sempre que necessário durante esta lição você pode retornar neste notebook e uasr o método acima para pbter novos dados.
