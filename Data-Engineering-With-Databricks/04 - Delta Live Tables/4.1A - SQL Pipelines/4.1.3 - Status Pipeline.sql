...
-- MAGIC
-- MAGIC Esta lição não pretende fornecer uma solução robusta para desenvolvimento e teste de código, em vez disso, destina-se ajudar os usuários a começar com DLT e lidar com  uma sintaxe desconhecida.
-- MAGIC
-- MAGIC ###Objetivos:
...
-- MAGIC
-- MAGIC Para começar este lição, siga o processo de adicionar este notebook ao seu pipeline usando a interface do usuário DLT e acione uma atualização.
-- MAGIC
