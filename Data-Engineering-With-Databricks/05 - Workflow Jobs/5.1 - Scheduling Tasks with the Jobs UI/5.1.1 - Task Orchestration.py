...
# MAGIC Novas atualizações para a interface do usuário de Jobs da Databricks adicionaram a capacidade de agendar várias tasks como parte de um job, permitindo que os jobs do Databricks manipulem totalmente a orquestração para a maioria das vagas de trabalho de produção.
# MAGIC
