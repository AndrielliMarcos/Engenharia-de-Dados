...
-- MAGIC 
-- MAGIC A célula abaixo executa uma lógica que nós podemos pensar como apenas representando um sistema externo atualizado diretamente os arquivos subjacentes à nossa tabela.
...
-- MAGIC %md
-- MAGIC Se observarmos a contagem atual de registros em nossa tabela, o número que vemos não refletirá essa novas linhas inseridas.
