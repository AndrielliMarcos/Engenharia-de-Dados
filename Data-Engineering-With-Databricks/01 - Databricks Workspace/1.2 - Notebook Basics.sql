...
-- MAGIC - Executar uma célula no notebook
...
-- MAGIC Notebooks oferecem execução de código célula por célula. Múltiplas linguagens podem ser misturadas nos notebooks. Os usuários podem adicionar plots, imagens e textos markdowns para aprimorar seu código.
-- MAGIC
-- MAGIC **Obs.:** A execução de código célula a célula significa que as células podem ser executadas múltiplas vezes ou fora de ordem. 
-- MAGIC
...
-- MAGIC %python
-- MAGIC print("Eu estou executando Python!")
...
-- MAGIC %python
-- MAGIC # comando para apagar tabelas e arquivos associados a esta lição.
-- MAGIC DA.cleanup()
