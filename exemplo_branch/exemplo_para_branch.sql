...
-- MAGIC %md
-- MAGIC Este notebook tem como objetivo o estudo para criação de uma nova branch no git.
-- MAGIC 
-- MAGIC 
-- MAGIC ### Passos:
-- MAGIC * Criação da Branch nova_branch_estudo
-- MAGIC * Clone de um notebook para esta branch para servir de exemplo
